  ...
  <div class="container is-widescreen">
    <div id="page">
      <div id="header">
        ...
        <p class="title is-3">About DAAWN</p>
      ...
      <p class="text"><a rel="license" href="http://creativecommons.org/licenses/by-nc/4.0/"><img alt="Creative Commons Licence" style="border-width:0; height: 35px;" src="https://mirrors.creativecommons.org/presskit/buttons/88x31/png/by-nc.png" /></a></p>
      ...
      <div class="level" >
        <div class="level-item">
          ...
          <p class="highlight special">Click <strong>Next</strong> for further information</p>
        </div>
        <div class="level-item">
