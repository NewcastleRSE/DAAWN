<template>
  <div class="container is-widescreen">
    <div id="page">
      ...
      <p class="text">We have provided a downloadable <a href="public/CI-form.docx" download>clinical interpretation form</a> to accompany the DAAWN PDF downloads.. Please feel free to use this to support interpretation of the DAAWN data and to personalise the assessment information for your client. </p>
