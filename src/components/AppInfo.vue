  ...
  <div class="container is-widescreen">
    <div id="page">
      ...
      <div id="task-table">
        <table class="table">
          <thead>
           <tr><th>Single word typed naming task </th><th>Copy task</th><th>Free text generation (phrase/sentence/narrative) </th></tr>
          </thead>
          <tbody>
           <tr>
      ...
      <p class="text">We have provided a downloadable <a href="public/CI-form.docx" download>clinical interpretation form</a> to accompany the DAAWN PDF downloads. Please feel free to use this to accompany the DAAWN data and to personalise the assessment information for your client. </p>
      <p class="text">Please see the DAAWN <a href="public/UserGuide.docx" download>user guide</a> for detailed information on DAAWN output. You may also wish to visit our <a href="faqs" target="_blank">FAQ page</a>. </p>
